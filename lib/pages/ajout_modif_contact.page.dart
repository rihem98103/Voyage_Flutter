...
class _AjoutModifContactPageState extends State<AjoutModifContactPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      drawer: MyDrawer(),
      appBar: AppBar(title: Text(widget.modifMode ? 'Page Modifier Contact' : 'Page Ajouter Contact'
      ),),
      body: Form(
        key: globalKey,
        child: _formUI(),
            ...
            FormHelper.inputFieldWidgetWithLabel(
              ...
              "",
                ...
                return null;
                  ...
                  (onSaved) {
                contact!.prenom = onSaved.toString().trim();
              },
              initialValue: widget.modifMode ? contact!.prenom!:"",
              showPrefixIcon: true,
