...
class MeteoDetailsPage extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _MeteoDetailsPageState();
}
...
class _MeteoDetailsPageState extends State<MeteoDetailsPage> {
  ...
  void getMeteoData(String ville) {
    ...
    String url = "https://api.openweathermap.org/data/2.5/forecast?q=${ville}&appid=a574e704273aeb9796d541651ea93ba1";
  ...
  {
    return Scaffold(
        appBar: AppBar(title:Text('Page Meteo Details ${widget.ville}'),backgroundColor: Colors.redAccent),
        ...
        ListView.builder(
          ...
          itemBuilder: (context, index){
                    ...
                    children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text("${new DateFormat('HH:mm').format(DateTime.fromMicrosecondsSinceEpoch(meteoData['list'][index]['dt']*1000000))}"" | ${meteoData['list'][index]['weather'][0]['main']}",
                            style: TextStyle(
                                fontSize: 22,fontWeight: FontWeight.bold
                            ),),
                        ],
            ...
            //child: Text('Page Meteo Details ${widget.ville}',style: TextStyle(fontSize: 22),)
